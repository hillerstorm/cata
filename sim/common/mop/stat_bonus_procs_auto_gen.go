...
func RegisterAllProcs() {
	...
	//
	// Your healing spells grant 88 Spirit for the next 10s, stacking up to 10 times.
	...
	//	Harmful:  true,
	// }, []shared.ItemVariant{
	//	{ItemID: 77199, ItemName: "Heart of Unliving (N)"},
	//	{ItemID: 77976, ItemName: "Heart of Unliving (LFR) (Raid Finder)"},
	//	{ItemID: 77996, ItemName: "Heart of Unliving (H)"},
	// })
	...
	// Your melee attacks have a chance to grant 1149 mastery for 20s.
	shared.NewProcStatBonusEffect(shared.ProcStatBonusEffect{
		Name:     "Master Pit Fighter",
		ItemID:   74035,
		Callback: core.CallbackOnSpellHitDealt,
