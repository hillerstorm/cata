...
/*
Tooltip:
You kick upwards, dealing ${14.4*$<low>} to ${14.4*$<high>} damage and applying Mortal Wounds to the target.
Also causes all targets within $130320A1 yards to take an increased $130320m1% damage from your abilities for $130320d.
-- Mortal Wounds --
Grievously wounds the target, reducing the effectiveness of any healing received for $115804d.
