...
/*
Tooltip:
Pummel all targets in front of you with rapid hand strikes, stunning them and dealing ${7.5*$<low>} to ${7.5*$<high>} damage immediately and every $113656t2 sec for $113656d.
Damage is spread evenly over all targets.$?s125671[Your parry chance is increased by 100% while channeling.][]

$w2 damage every $t2 sec. $?s125671[Parrying all attacks.][]

$stnc=$?a103985[${1.2*0.89}][${1.0*0.89}] // 1.2 is probably the old stance modifier which is handled by the stance spell.
*/
